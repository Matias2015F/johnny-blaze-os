...
export default function PrePdfView({ order, setView, setFinalPdfData }) {
  ...
  return (
    <div className="p-6 text-left animate-in fade-in pb-32">
      ...
      <h2 className="text-3xl font-black text-white uppercase tracking-tighter mb-6">Antes de imprimir: Garantía</h2>
      <div className="bg-white p-8 rounded-[2.5rem] space-y-6 shadow-2xl">
        <div className="bg-blue-50 border-2 border-blue-200 p-4 rounded-3xl flex items-center gap-3">
          ...
          <p className="text-[10px] font-black text-blue-700 uppercase leading-tight">Al generar el comprobante, la orden se cierra. Ya no se podrán hacer cambios de último momento.</p>
        </div>
        <div>
