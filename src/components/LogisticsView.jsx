      ...
      <div className="bg-white p-8 rounded-[2.5rem] space-y-5 shadow-2xl text-left">
        ...
        <div className="space-y-4 pt-4">
          <div className="space-y-1">
            <label className="text-[10px] uppercase text-slate-400 ml-2 font-black">Descripción del flete</label>
          ...
          <div className="space-y-1">
            <label className="text-[10px] uppercase text-slate-400 ml-2 font-black">Costo del flete ($)</label>
