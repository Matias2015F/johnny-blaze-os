  ...
  return (
    <div className="animate-in slide-in-from-bottom duration-300 pb-32 text-left">
        ...
        <div className="rounded-[2rem] border border-white/10 bg-zinc-900/90 p-5 shadow-2xl backdrop-blur-xl">
          <div className="flex items-center gap-4">
            ...
            <div className="min-w-0">
              <p className="text-[10px] font-black uppercase tracking-[0.3em] text-orange-400">Cobro</p>
              <h2 className="mt-1 text-xl font-black uppercase tracking-widest text-white">Pagos del trabajo</h2>
              <p className="mt-1 truncate text-[10px] font-black uppercase tracking-widest text-zinc-500">
      ...
      <div className="space-y-5 px-4 pt-4">
        ...
        <div className="rounded-[2.5rem] border border-zinc-800 bg-zinc-900 p-5 shadow-xl">
          <p className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-500">Registrar pago</p>
          ...
          <div className="relative mt-4 rounded-[2rem] border border-white/10 bg-black/20 px-4 py-4">
            <span className="absolute left-5 top-1/2 -translate-y-1/2 text-xl font-black text-orange-400">$</span>
            <input
              type="text"
              value={monto}
              onChange={(e) => setMonto(e.target.value)}
              placeholder="Ej: 15000"
              className="w-full bg-transparent py-2 pl-6 pr-2 text-3xl font-black text-white outline-none placeholder:text-zinc-600"
            />
          </div>
          ...
          <input
            ...
            className="mt-4 w-full rounded-[1.5rem] border border-white/10 bg-black/20 p-4 text-sm font-bold text-white outline-none placeholder:text-zinc-600 focus:border-orange-500"
          />

          <button
            onClick={registrar}
            className="mt-4 flex w-full items-center justify-center gap-3 rounded-[2rem] bg-white py-5 font-black uppercase tracking-widest text-zinc-950 shadow-xl transition-all active:scale-95"
          >
            <Check size={20} />
            Registrar pago
          </button>
          ...
          {pagoCompleto && (
            <button
              ...
              className="mt-3 flex w-full items-center justify-center gap-3 rounded-[2rem] bg-orange-600 py-4 text-[10px] font-black uppercase tracking-[0.2em] text-white shadow-xl transition-all active:scale-95"
            >
              <ReceiptText size={18} />
        ...
        <div className="rounded-[2.5rem] border border-zinc-800 bg-zinc-900 p-5 shadow-xl">
          <p className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-500">Pagos registrados</p>
