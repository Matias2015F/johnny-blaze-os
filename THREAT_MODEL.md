...
| T10 | Compromiso de dependencia npm en una actualización permite ejecución de código arbitrario en build o runtime | supply_chain | Supply chain (npm, build pipeline) | Todos los assets | critical | rare | partially_mitigated | npm audit --audit-level=high en CI desde `d828ed4`; sin hash pinning de integridad | |
...
| Habilitar Dependabot en el repo para alertas automáticas de vulnerabilidades en dependencias npm | T10 | partial | S |
