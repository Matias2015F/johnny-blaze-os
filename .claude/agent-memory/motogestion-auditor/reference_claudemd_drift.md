...
**Resolved 2026-07-14:** calc.js path corrected to `src/lib/calc.js` in CLAUDE.md, SKILL.md and contexto-motogestion-actual.md (commit pending push in same session).
